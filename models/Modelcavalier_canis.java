...
public static class Modelcavalier_canis extends EntityModel<Entity> {
	...
	public Modelcavalier_canis() {
		...
		tail.setTextureOffset(17, 73).addBox(-1.5F, -0.2173F, -1.7517F, 3.0F, 12.0F, 3.0F, 0.0F, false);
		...
		tail_tip_r1.setTextureOffset(82, 53).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, 0.0F, false);
		...
		left_fore_leg_r1.setTextureOffset(58, 78).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 10.0F, 3.0F, 0.0F, false);
		...
		bone3_r1_r1.setTextureOffset(66, 0).addBox(2.25F, -21.5F, -9.5F, 3.0F, 12.0F, 5.0F, 0.0F, false);
		...
		right_fore_leg_r1.setTextureOffset(58, 78).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 10.0F, 3.0F, 0.0F, false);
		...
		bone2_r1_r1.setTextureOffset(66, 0).addBox(-5.25F, -21.5F, -9.5F, 3.0F, 12.0F, 5.0F, 0.0F, false);
		...
		bone4.setTextureOffset(0, 73).addBox(2.25F, -29.4251F, 0.5798F, 3.0F, 11.0F, 5.0F, 0.0F, false);

		bone8 = new ModelRenderer(this);
		bone8.setRotationPoint(-2.5F, -1.0F, 6.0F);
		bone6.addChild(bone8);
		setRotationAngle(bone8, 1.2653F, 0.0F, 0.0F);
		bone8.setTextureOffset(43, 82).addBox(2.25F, -6.9251F, 0.5798F, 3.0F, 7.0F, 3.0F, 0.0F, false);
		...
		bone7_r1.setTextureOffset(30, 82).addBox(-1.5F, -1.0F, -2.0F, 3.0F, 7.0F, 3.0F, 0.0F, false);
		...
		bone.setTextureOffset(0, 73).addBox(-1.25F, -3.4251F, -1.6702F, 3.0F, 11.0F, 5.0F, 0.0F, false);

		bone11 = new ModelRenderer(this);
		bone11.setRotationPoint(1.5F, -0.9409F, 5.8377F);
		bone10.addChild(bone11);
		setRotationAngle(bone11, 1.2653F, 0.0F, 0.0F);
		bone11.setTextureOffset(43, 82).addBox(-6.25F, -6.9251F, 0.5798F, 3.0F, 7.0F, 3.0F, 0.0F, false);
		...
		bone12_r1.setTextureOffset(30, 82).addBox(-1.5F, -1.0F, -2.0F, 3.0F, 7.0F, 3.0F, 0.0F, false);
		...
		whole_head.setTextureOffset(0, 57).addBox(-5.5F, -4.1387F, -4.4342F, 11.0F, 10.0F, 5.0F, 0.0F, false);
		whole_head.setTextureOffset(58, 65).addBox(-4.25F, -2.6387F, -7.4342F, 8.0F, 8.0F, 4.0F, 0.0F, false);
		whole_head.setTextureOffset(82, 75).addBox(-2.25F, 0.6113F, -10.4342F, 4.0F, 2.0F, 3.0F, 0.0F, false);
		...
		whole_head_r1.setTextureOffset(43, 46).addBox(-3.0F, -28.1387F, -12.9342F, 3.0F, 3.0F, 1.0F, 0.0F, false);
		...
		whole_head_r2.setTextureOffset(43, 46).addBox(0.0F, -28.1387F, -12.9342F, 3.0F, 3.0F, 1.0F, 0.0F, false);
		...
		jaw.setRotationPoint(0.0F, 3.47F, -6.5F);
		whole_head.addChild(jaw);
		setRotationAngle(jaw, 0.6981F, 0.0F, 0.0F);
		jaw.setTextureOffset(79, 14).addBox(-2.25F, -0.6087F, -3.9342F, 4.0F, 2.0F, 4.0F, 0.0F, false);

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(-1.5F, 0.7355F, 19.9973F);
		jaw.addChild(bone5);
		setRotationAngle(bone5, -0.2182F, 0.0F, 0.0F);
		bone5.setTextureOffset(83, 0).addBox(-0.25F, 3.9058F, -23.1815F, 3.0F, 2.0F, 3.0F, 0.0F, false);
		...
		bone13.setTextureOffset(43, 46).addBox(-5.0F, 1.7842F, 5.0385F, 10.0F, 9.0F, 9.0F, 0.0F, false);

		bone14 = new ModelRenderer(this);
		bone14.setRotationPoint(0.0F, 13.2669F, 8.0908F);
		whole_body.addChild(bone14);
		setRotationAngle(bone14, 1.4836F, 0.0F, 0.0F);
		bone14.setTextureOffset(37, 28).addBox(-6.0F, -8.5477F, 9.392F, 12.0F, 7.0F, 10.0F, 0.0F, false);
		...
		bone16_r1.setTextureOffset(0, 38).addBox(-5.5F, -16.2499F, 4.2499F, 11.0F, 8.0F, 10.0F, 0.0F, false);
		...
		mane_rotation2_r1.setTextureOffset(0, 19).addBox(-6.0F, -8.4999F, 6.2499F, 12.0F, 7.0F, 11.0F, 0.0F, false);
		...
		mane3.setTextureOffset(5, 41).addBox(-5.25F, -0.4658F, -14.2115F, 8.0F, 8.0F, 7.0F, 0.0F, false);
		...
		mane_rotation3_r1_r1.setTextureOffset(0, 0).addBox(-6.5F, -7.2499F, 12.9999F, 13.0F, 7.0F, 11.0F, 0.0F, false);
		...
		head.setRotationPoint(0.0F, -16.7025F, 0.7202F);
		head.setTextureOffset(41, 11).addBox(-4.0F, -7.2975F, -4.9702F, 8.0F, 7.0F, 8.0F, 0.0F, false);
		...
		bone_r7.setTextureOffset(79, 62).addBox(-3.1194F, -4.6668F, -33.0231F, 6.0F, 3.0F, 3.0F, 0.0F, false);

		eyes = new ModelRenderer(this);
		eyes.setRotationPoint(-0.3806F, 28.7089F, -7.6378F);
		head.addChild(eyes);
		eyes.setTextureOffset(38, 0).addBox(-2.1194F, -32.5064F, 2.4176F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		eyes.setTextureOffset(38, 0).addBox(1.8806F, -32.5064F, 2.4176F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bone_r2.setTextureOffset(38, 0).addBox(-3.6194F, -27.7786F, 13.1479F, 7.0F, 2.0F, 6.0F, 0.0F, false);

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, -5.0F, 19.0F);
		...
		bone_r3.setTextureOffset(33, 65).addBox(-4.0F, -5.2574F, -0.0088F, 8.0F, 12.0F, 4.0F, 0.0F, false);
		...
		bone_r4_r1.setTextureOffset(72, 24).addBox(-3.5F, -3.0F, -2.5F, 7.0F, 6.0F, 3.0F, 0.0F, false);

		right_arm = new ModelRenderer(this);
		right_arm.setRotationPoint(5.4408F, -11.36F, 1.0228F);
		...
		cube_r9.setTextureOffset(72, 34).addBox(-3.75F, -0.25F, -1.5F, 7.0F, 0.0F, 3.0F, 0.0F, false);
		...
		cube_r10.setTextureOffset(72, 34).addBox(-3.75F, 0.1F, -1.5F, 7.0F, 0.0F, 3.0F, 0.0F, false);
		...
		right_arm_r1.setTextureOffset(71, 78).addBox(-1.5F, -3.75F, -2.0F, 3.0F, 6.0F, 4.0F, 0.0F, false);
		...
		bone_r6_r1.setTextureOffset(78, 42).addBox(-2.0F, -3.0F, -1.75F, 4.0F, 6.0F, 4.0F, 0.0F, false);

		left_arm = new ModelRenderer(this);
		left_arm.setRotationPoint(-5.377F, -11.2054F, 0.5871F);
		...
		left_arm_r1.setTextureOffset(71, 78).addBox(-1.5F, -4.0F, -3.0F, 3.0F, 6.0F, 4.0F, 0.0F, false);
		...
		bone_r5_r1.setTextureOffset(78, 42).addBox(-2.0F, -3.0F, -1.25F, 4.0F, 6.0F, 4.0F, 0.0F, false);
	}
