...
public static class Modeltame_canis_chordata extends EntityModel<Entity> {
	...
	public Modeltame_canis_chordata() {
		textureWidth = 128;
		textureHeight = 128;
		...
		setRotationAngle(whole_head_r1, 0.2618F, 0.0F, 0.2618F);
		whole_head_r1.setTextureOffset(1, 1).addBox(-4.25F, -27.25F, -16.0F, 3.0F, 3.0F, 1.0F, 0.0F, false);

		whole_head_r2 = new ModelRenderer(this);
		whole_head_r2.setRotationPoint(0.0F, 17.5F, 15.0F);
		whole_head.addChild(whole_head_r2);
		setRotationAngle(whole_head_r2, 0.2618F, 0.0F, -0.2618F);
		whole_head_r2.setTextureOffset(1, 1).addBox(0.75F, -27.25F, -16.0F, 3.0F, 3.0F, 1.0F, 0.0F, false);
		...
		bone16.setTextureOffset(0, 24).addBox(-5.0F, -8.0F, 4.5F, 10.0F, 10.0F, 13.0F, 0.0F, false);
		...
		mane_rotation3_r1.setTextureOffset(0, 0).addBox(-6.5F, -25.0F, 9.3F, 13.0F, 11.0F, 12.0F, 0.0F, false);
		...
		bone.setTextureOffset(17, 69).addBox(-5.25F, -31.0F, 4.25F, 3.0F, 11.0F, 5.0F, 0.0F, false);

		bone11 = new ModelRenderer(this);
		bone11.setRotationPoint(-0.5F, -1.9409F, 5.8377F);
		bone10.addChild(bone11);
		setRotationAngle(bone11, 1.2653F, 0.0F, 0.0F);
		bone11.setTextureOffset(34, 75).addBox(-4.25F, -4.5F, 3.5F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		bone12 = new ModelRenderer(this);
		bone12.setRotationPoint(-2.2F, 1.0591F, 9.7377F);
		bone10.addChild(bone12);
		setRotationAngle(bone12, 0.5672F, 0.0F, 0.0F);
		bone12.setTextureOffset(0, 24).addBox(-2.8F, -6.25F, 2.6F, 3.0F, 8.0F, 3.0F, 0.0F, false);
		...
		bone4.setTextureOffset(17, 69).addBox(2.25F, -31.0F, 4.25F, 3.0F, 11.0F, 5.0F, 0.0F, false);

		bone8 = new ModelRenderer(this);
		bone8.setRotationPoint(-2.5F, -2.0F, 6.0F);
		bone6.addChild(bone8);
		setRotationAngle(bone8, 1.2653F, 0.0F, 0.0F);
		bone8.setTextureOffset(34, 75).addBox(2.25F, -4.5F, 3.5F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		bone7 = new ModelRenderer(this);
		bone7.setRotationPoint(0.2F, 1.0F, 9.9F);
		bone6.addChild(bone7);
		setRotationAngle(bone7, 0.5672F, 0.0F, 0.0F);
		bone7.setTextureOffset(0, 24).addBox(-0.2F, -6.25F, 2.6F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		right_fore_leg = new ModelRenderer(this);
		right_fore_leg.setRotationPoint(-3.5F, 11.0F, -11.0F);
		right_fore_leg.setTextureOffset(72, 34).addBox(-1.5F, 3.0F, 0.0F, 3.0F, 10.0F, 3.0F, 0.0F, false);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(3.5F, 7.0F, 5.0F);
		right_fore_leg.addChild(bone2);
		setRotationAngle(bone2, 0.5236F, 0.0F, 0.0F);
		bone2.setTextureOffset(0, 69).addBox(-5.25F, -15.5F, -3.5F, 3.0F, 12.0F, 5.0F, 0.0F, false);

		left_fore_leg = new ModelRenderer(this);
		left_fore_leg.setRotationPoint(3.5F, 11.0F, -11.0F);
		left_fore_leg.setTextureOffset(72, 34).addBox(-1.5F, 3.0F, 0.0F, 3.0F, 10.0F, 3.0F, 0.0F, false);

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(-3.5F, 7.0F, 5.0F);
		left_fore_leg.addChild(bone3);
		setRotationAngle(bone3, 0.5236F, 0.0F, 0.0F);
		bone3.setTextureOffset(0, 69).addBox(2.25F, -15.5F, -3.5F, 3.0F, 12.0F, 5.0F, 0.0F, false);
		...
		tail_tip.setTextureOffset(64, 75).addBox(-2.5F, 4.0F, 6.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.right_fore_leg.rotateAngleX = MathHelper.cos(f * 1.0F) * 1.0F * f1;
