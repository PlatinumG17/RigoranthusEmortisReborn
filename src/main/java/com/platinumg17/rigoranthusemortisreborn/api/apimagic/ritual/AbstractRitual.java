...
public abstract class AbstractRitual {
    ...
    public String getName(){
        return new TranslationTextComponent("item.rigoranthusemortisreborn.ritual_" + getID()).getString();
    }

    public String getDescription(){
        return new TranslationTextComponent("rigoranthusemortisreborn.ritual_desc." + getID()).getString();
    }
