...
public class SpellStats {
    ...
    public List<ITextComponent> addTooltip(List<ITextComponent> components){
        if(this.damageModifier != 0.0d)
            components.add(new TranslationTextComponent("tooltip.rigoranthusemortisreborn.spell_damage", this.damageModifier).setStyle(Style.EMPTY.withColor(TextFormatting.BLUE)));
        if(this.durationMultiplier != 0.0d)
            components.add(new TranslationTextComponent("tooltip.rigoranthusemortisreborn.duration_modifier", this.durationMultiplier).setStyle(Style.EMPTY.withColor(TextFormatting.GREEN)));
        if(this.amplification != 0.0d)
            components.add(new TranslationTextComponent("tooltip.rigoranthusemortisreborn.amp_modifier", this.amplification).setStyle(Style.EMPTY.withColor(TextFormatting.RED)));
        return components;
    }
