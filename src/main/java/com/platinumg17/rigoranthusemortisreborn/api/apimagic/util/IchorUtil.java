...
public class IchorUtil {
     ...
     */
    @Nullable
    public static BlockPos takeIchorNearby(BlockPos pos, World world, int range, int ichor){
    ...
    public static @Nullable BlockPos takeIchorNearbyWithParticles(BlockPos pos, World world, int range, int ichor){
     ...
     * Returns the position where the ichor was taken, or null if none were found.
     */
    public static boolean hasIchorNearby(BlockPos pos, World world, int range, int ichor){
        Optional<BlockPos> loc = BlockPos.findClosestMatch(pos, range, range, (b) -> world.getBlockEntity(b) instanceof IchorJarTile && ((IchorJarTile) world.getBlockEntity(b)).getCurrentIchor() >= ichor);
        return loc.isPresent();
    }

    @Nullable
    public static BlockPos canGiveIchorClosest(BlockPos pos, World world, int range){
    ...
    public static List<BlockPos> canGiveIchorAny(BlockPos pos, World world, int range){
