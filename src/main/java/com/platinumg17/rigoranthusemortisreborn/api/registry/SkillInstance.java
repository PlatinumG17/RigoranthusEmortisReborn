...
public class SkillInstance implements ICanisTransmogrification {
    ...
    public void writeToNBT(AbstractCanisEntity canisIn, CompoundNBT compound) {compound.putInt("level", this.level());}
    public void readFromNBT(AbstractCanisEntity canisIn, CompoundNBT compound) {this.setLevel(compound.getInt("level"));}
    ...
    public final void writeInstance(AbstractCanisEntity canisIn, CompoundNBT compound) {
    ...
    public static Optional<SkillInstance> readInstance(AbstractCanisEntity canisIn, CompoundNBT compound) {
