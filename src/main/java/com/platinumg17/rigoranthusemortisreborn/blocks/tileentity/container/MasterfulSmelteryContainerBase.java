...
public abstract class MasterfulSmelteryContainerBase extends Container {
    ...
    public MasterfulSmelteryContainerBase(ContainerType<?> containerType, int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        this(containerType, windowId, world, pos, playerInventory, player, new IntArray(5));
    }

    public MasterfulSmelteryContainerBase(ContainerType<?> containerType, int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, IIntArray fields) {
    ...
    public ITextComponent getTooltip(int index) {
        ...
        {
            case 1:
                return new TranslationTextComponent("tooltip." + RigoranthusEmortisReborn.MOD_ID + ".gui_input");
            case 2:
                return new TranslationTextComponent("tooltip." + RigoranthusEmortisReborn.MOD_ID + ".gui_output");
            case 3:
                return new TranslationTextComponent("tooltip." + RigoranthusEmortisReborn.MOD_ID + ".gui_input_output");
            case 4:
                return new TranslationTextComponent("tooltip." + RigoranthusEmortisReborn.MOD_ID + ".gui_fuel");
            default:
                return new TranslationTextComponent("tooltip." + RigoranthusEmortisReborn.MOD_ID + ".gui_none");
        }
    }
