...
@OnlyIn(Dist.CLIENT)
public class SmallForwardButton extends Button {

    public SmallForwardButton(int x, int y, ITextComponent text, IPressable onPress) {
    ...
    public void renderButton(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.blit(stack, this.x, this.y, 0, i * 14, this.width, this.height);
