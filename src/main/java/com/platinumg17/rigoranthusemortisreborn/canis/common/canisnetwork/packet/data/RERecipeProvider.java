...
public class RERecipeProvider extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(CanisItems.SUPER_TREAT.get(), 5).requires(CanisItems.TRAINING_TREAT.get(), 5).requires(Items.GOLDEN_APPLE, 1).unlockedBy("has_golden_apple", has(Items.GOLDEN_APPLE)).save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(CanisItems.MASTER_TREAT.get(), 5).requires(CanisItems.SUPER_TREAT.get(), 5).requires(Items.DIAMOND, 1).unlockedBy("has_master_treat", has(CanisItems.SUPER_TREAT.get())).save(consumer);
