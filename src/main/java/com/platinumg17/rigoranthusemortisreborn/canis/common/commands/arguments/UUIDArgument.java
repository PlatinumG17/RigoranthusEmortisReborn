package com.platinumg17.rigoranthusemortisreborn.canis.common.commands.arguments;
...
public class UUIDArgument implements ArgumentType<UUID> {
    ...
    public static final DynamicCommandExceptionType UUID_SECTION_INVALID = new DynamicCommandExceptionType((arg) -> {
        return new TranslationTextComponent("argument.rigoranthusemortisreborn.uuid.section.invalid", arg);
    });

    public static final DynamicCommandExceptionType UUID_FORMAT_INVALID = new DynamicCommandExceptionType((arg) -> {
        return new TranslationTextComponent("argument.rigoranthusemortisreborn.uuid.format.invalid", arg);
    });

    public static UUIDArgument uuid() {return new UUIDArgument();}
