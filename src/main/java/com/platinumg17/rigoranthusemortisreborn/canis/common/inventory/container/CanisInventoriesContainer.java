...
public class CanisInventoriesContainer extends Container {
    ...
    //Server method
    public CanisInventoriesContainer(int windowId, PlayerInventory playerInventory, IntArray trackableArray) {
    ...
    public void addCanisSlots() {
        ...
        for (int i = 0; i < this.trackableArray.getCount(); i++) {
            ...
            if (entity instanceof CanisEntity) {
                ...
                int level = MathHelper.clamp(canis.getLevel(CanisSkills.WAYWARD_TRAVELLER), 0, 5); // Number of rows for this canis
