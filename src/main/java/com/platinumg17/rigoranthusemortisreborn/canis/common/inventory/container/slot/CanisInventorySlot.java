...
public class CanisInventorySlot extends SlotItemHandler {
    ...
    public CanisInventorySlot(CanisEntity canisIn, PlayerEntity playerIn, IItemHandler itemHandler, int overallColumn, int row, int col, int index, int xPosition, int yPosition) {
