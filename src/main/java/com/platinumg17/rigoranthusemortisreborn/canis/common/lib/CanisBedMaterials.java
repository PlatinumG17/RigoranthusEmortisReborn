...
public class CanisBedMaterials {

    public static final DeferredRegister<IBeddingMaterial> BEDDINGS = DeferredRegister.create(IBeddingMaterial.class, EmortisConstants.VANILLA_ID);
    public static final DeferredRegister<ICasingMaterial> CASINGS = DeferredRegister.create(ICasingMaterial.class, EmortisConstants.VANILLA_ID);
