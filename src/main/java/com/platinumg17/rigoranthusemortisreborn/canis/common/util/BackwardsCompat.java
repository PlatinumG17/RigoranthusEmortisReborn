...
//    public static Optional<Supplier<? extends Skill>> getSkillMap(String oldId) {
//        return Optional.ofNullable(OLD_NEW_SKILL.get(oldId));
//    }

    public static void readSkillMapping(CompoundNBT compound, List<SkillInstance> skillMap) {
//        if (compound.contains("skills", Constants.NBT.TAG_STRING)) {
//            String[] split = compound.getString("skills").split(":");
//            if (split.length > 0 && split.length % 2 == 0) {
//                for (int i = 0; i < split.length; i += 2) {
//                    final int levelIndex = i + 1;
//                    BackwardsCompat.getSkillMap(split[i]).ifPresent((skill) -> {
//                        int level = 0;
//                        try {
...
//                            skillMap.add(skill.get().getDefault(level));
//                        }
//                    });
//                }
//            }
...
//            accouterments.add(CanisAccouterments.RADIO_BAND.get().getDefault());
//        }
...
//            if (value >= 0) {
//                accouterments.add(CanisAccouterments.DYEABLE_CAPE.get().create(value));
//            } else if (value >= -1) {
//                accouterments.add(CanisAccouterments.DYEABLE_CAPE.get().getDefault());
//            }
//        }
...
//                "df167655cf5db4147e28d6920862636ce94c22cd", "b82d3e99a8ef342fbdc5f5a3f6c91b3940f80f55",
//            };
