...
public class EntityUtil {
    ...
    public static double getFollowRange(LivingEntity entityIn) {
        ...
        return rangeAttribute == null ? 16.0D : rangeAttribute.getValue(); // was 16.0D
    }
    ...
    public static int getRandomNumber(LivingEntity entityIn, int minIn, int maxIn) {return entityIn.getRandom().nextInt(maxIn - minIn + 1) + minIn;}
    public static boolean isHolding(@Nullable Entity entity, Item item, Predicate<CompoundNBT> nbtPredicate) {return isHolding(entity, stack -> stack.getItem() == item && stack.hasTag() && nbtPredicate.test(stack.getTag()));}
    public static boolean isHolding(@Nullable Entity entity, Item item) {return isHolding(entity, stack -> stack.getItem() == item);}
    ...
    public static <T extends Entity> T getClosestTo(Entity center, Iterable<T> entities) {return getClosestTo(center.position(), entities);}
