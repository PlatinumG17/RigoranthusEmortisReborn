...
public class REUtil {
    ...
    public static String format1DP(double value) {
        return REUtil.dfShort.format(value);
    }

    public static String format2DP(double value) {
        return REUtil.dfShortDouble.format(value);
    }
    ...
    public static int colorDye(int startColor, Collection<DyeColor> dyes) {
        List<int[]> colors = dyes.stream()
                ...
                .mapToObj(REUtil::rgbIntToIntArray)
    ...
    public static ResourceLocation getResource(String name) {
        return getResource(EmortisConstants.MOD_ID, name);
    }
    ...
    public static String getResourcePath(String name) {
        return getResourcePath(EmortisConstants.MOD_ID, name);
    }
