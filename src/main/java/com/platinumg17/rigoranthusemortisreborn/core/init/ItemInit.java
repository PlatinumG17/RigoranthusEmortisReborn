...
import com.platinumg17.rigoranthusemortisreborn.items.weapons.type.magic.CryOfDesperationItem;
...
public class ItemInit {
	...
	public static final RegistryObject<Item> BILIS_BERRY = ITEMS.register("bilis_berry",
			() -> new BlockNamedItem(Registration.SPECTABILIS_BUSH.get(), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).food(EmortisEdibles.BILIS_BERRY)));
	...
	public static final RegistryObject<Item> BUCKET_OF_CADAVEROUS_ICHOR = ITEMS.register("bucket_of_cadaverous_ichor",
			() -> new BucketItem(() -> FluidRegistry.CADAVEROUS_ICHOR_FLUID.get(),
					new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final RegistryObject<Item> RAZOR_TOOTH = ITEMS.register("razor_tooth",
			() -> new RazorToothItem(new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> RAZORTOOTH_KUNAI = ITEMS.register("razortooth_kunai",
			() -> new ConsumableProjectileWeaponItem(new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP), 1.5F, 2.4F,3));
	...
	public static final RegistryObject<Item> BILI_BOMB = ITEMS.register("bili_bomb",
			() -> new BiliBombItem(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> RISSAI = ITEMS.register("rissai",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.PRISMARIC, 3, -2.4F).efficiency(1.0F).set(ToolRegistry.SWORD_TOOL).add(
					OnHitEffect.SWEEP), new Item.Properties().defaultDurability(100).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> MORRAI = ITEMS.register("morrai",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.FROSTBITTEN, 6, -2.4F).efficiency(1.0F).set(ToolRegistry.SWORD_TOOL).add(
					OnHitEffect.SWEEP).add(OnHitEffect.ICE_SHARD), new Item.Properties().defaultDurability(200).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> ANDURIL = ITEMS.register("anduril",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.GHAST_IRON, 3, -2.4F).efficiency(15.0F).set(ToolRegistry.SWORD_TOOL).add(
					OnHitEffect.SWEEP).add(OnHitEffect.setOnFire(10)), new Item.Properties().defaultDurability(350).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> LUCK_OF_HEPHAESTUS = ITEMS.register("luck_of_hephaestus",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.GHAST_IRON, 4, -2.4F).efficiency(15.0F).set(ToolRegistry.SWORD_TOOL).add(
					OnHitEffect.SWEEP).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new EffectInstance(Effects.WITHER, 100, 1)))), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> SICKLE = ITEMS.register("sickle",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.IRON, 2, -2.2F).efficiency(1.5F).
					disableShield().set(ToolRegistry.SICKLE_TOOL), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> SICKLYTH = ITEMS.register("sicklyth",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.BLIGHT_TIER, 6, -2.2F).efficiency(4.0F).disableShield().set(ToolRegistry.SICKLE_TOOL).add(
					OnHitEffect.PSYCHO_BLIGHT), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> CLAWS_DRAWN = ITEMS.register("claws_drawn",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.DIAMOND, 5, -1.5F).efficiency(10.0F).set(ToolRegistry.CLAWS_TOOL).set(
					ItemRightClickEffect.switchTo(() -> ItemInit.CLAWS_SHEATHED.get())), new Item.Properties().defaultDurability(4096).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> CLAWS_SHEATHED = ITEMS.register("claws_sheathed",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.DIAMOND, -1, -1.0F).efficiency(10.0F).set(
					ItemRightClickEffect.switchTo(() -> ItemInit.CLAWS_DRAWN.get())), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> STEOCLASTS_DRAWN = ITEMS.register("steoclasts_drawn",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.PROSAIC, 6, -1.5F).efficiency(10.0F).set(ToolRegistry.CLAWS_TOOL).set(
					...
					EntityType.SKELETON)), new Item.Properties().defaultDurability(1250).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> STEOCLASTS_SHEATHED = ITEMS.register("steoclasts_sheathed",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.PROSAIC, -1, -1.0F).efficiency(10.0F).set(
					ItemRightClickEffect.switchTo(() -> ItemInit.STEOCLASTS_DRAWN.get())), new Item.Properties().defaultDurability(1250)));
	...
	public static final RegistryObject<Item> TYRO_STICK = ITEMS.register("tyro_stick",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.WOOD, 0, -1.0F).efficiency(1.0F).set(ToolRegistry.MISC_TOOL), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));

	public static final RegistryObject<Item> PROHIBATE_STICK = ITEMS.register("prohibate_stick",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.PRISMARIC, -1, -1.0F).efficiency(1.0F).set(ToolRegistry.MISC_TOOL), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> BLACKTHORN_WAND = ITEMS.register("blackthorn_wand",
 ...
 .add(OnHitEffect.LIFE_SATURATION)
	...
	public static final RegistryObject<Item> DESOLATOR_MACE = ITEMS.register("desolator_mace",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.IRON, 1, -2.8F).efficiency(2.0F).set(ToolRegistry.MISC_TOOL).add(
				OnHitEffect.armorBypassingDamageMod(4)), new Item.Properties().defaultDurability(2048).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> FAN = ITEMS.register("fan",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.IRON, 1, -1.0F).efficiency(1.5F).set(ToolRegistry.MISC_TOOL).set(
				ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
	...
	public static final RegistryObject<Item> STEOCLASTS_SHEATHED = ITEMS.register("typhonic_trivializer",
			() -> new REWeaponItem(new REWeaponItem.Builder(RigoranthusItemTier.ESOTERIC_TIER, 2, -1.0F).efficiency(1.5F).set(ToolRegistry.MISC_TOOL).set(
				ItemRightClickEffect.extinguishFire(3)).add(OnHitEffect.BREATH_LEVITATION_AOE).add(OnHitEffect.enemyKnockback(2.0F)), new Item.Properties().tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> ELECTRO_AXE_CHARGED = ITEMS.register("electro_axe_charged",
			() -> new REWeaponItem(new REWeaponItem.Builder(ItemTier.IRON, 8, -3.0F).efficiency(6.0F).disableShield().set(ToolRegistry.AXE_TOOL).set(ItemRightClickEffect.switchTo(() -> ELECTRO_AXE_SPENT)).add(
				OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(() -> RigoranthusSoundRegistry.EVENT_ELECTRO_SHOCK.get(), 0.6F, 1.0F)), new Item.Properties().defaultDurability(800).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP)));
