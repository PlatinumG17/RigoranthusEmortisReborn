...
public class DelphicBloomEntity extends LivingEntity implements IAnimatable, IEntityAdditionalSpawnData {
    ...
    public DelphicBloomEntity(EntityType<? extends DelphicBloomEntity> type, World worldIn) {
        super(type, worldIn);
...
//                if(eventTimer >= Config.delphicRestorationTime.get() * 20) //600(default) seconds from animation start to flower restoration
    ...
    @Override public ItemStack getItemBySlot(EquipmentSlotType slotIn) {return ItemStack.EMPTY;}
    @Override public void setItemSlot(EquipmentSlotType slotIn, ItemStack stack) {}
