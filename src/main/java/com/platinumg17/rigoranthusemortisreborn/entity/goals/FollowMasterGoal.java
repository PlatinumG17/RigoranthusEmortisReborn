...
public class FollowMasterGoal extends Goal {
    ...
    public void start() {
        ...
        this.oldWaterCost = this.cadaver.getPathfindingMalus(PathNodeType.WATER);
        this.cadaver.setPathfindingMalus(PathNodeType.WATER, 0.0F);
    }
    ...
    public void stop() {
        this.owner = null;
        this.navigator.stop();
        this.cadaver.setPathfindingMalus(PathNodeType.WATER, this.oldWaterCost);
    }
