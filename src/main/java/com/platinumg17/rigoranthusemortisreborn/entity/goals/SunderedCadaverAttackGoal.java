...
public class SunderedCadaverAttackGoal extends Goal {

    protected final SunderedCadaverEntity mob;
    ...
    public SunderedCadaverAttackGoal(SunderedCadaverEntity cadaver, boolean followUnseen) {
        this.mob = cadaver;
