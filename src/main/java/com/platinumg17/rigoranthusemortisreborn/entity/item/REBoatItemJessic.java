...
//import com.platinumg17.rigoranthusemortisreborn.entity.REBoatEntityJessic;
...
//                REBoatEntityJessic boatentity = new REBoatEntityJessic(worldIn, raytraceresult.getLocation().x, raytraceresult.getLocation().y, raytraceresult.getLocation().z);
