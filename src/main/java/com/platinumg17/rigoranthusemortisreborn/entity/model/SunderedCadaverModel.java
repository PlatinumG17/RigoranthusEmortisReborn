...
public class SunderedCadaverModel extends AnimatedGeoModel<SunderedCadaverEntity> {
...
//public class SunderedCadaverModel <T extends SunderedCadaverEntity> extends EntityModel<T> {
