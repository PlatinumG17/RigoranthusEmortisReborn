...
public class ShadowRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    public void doRenderShadow(T entity) {this.shadowRadius = entity.getBbWidth();}
    @Override public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {this.doRenderShadow(entityIn);}
