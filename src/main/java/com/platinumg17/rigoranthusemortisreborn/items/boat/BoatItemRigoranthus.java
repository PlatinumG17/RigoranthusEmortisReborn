package com.platinumg17.rigoranthusemortisreborn.items.boat;
//
...
//
//public class BoatItemRigoranthus extends Item {
//    private static final Predicate<Entity> ENTITY_PREDICATE = EntityPredicates.NO_SPECTATORS.and(Entity::isPickable);
//    private final BoatEntityRigoranthus.BoatModel model;
//
//    public BoatItemRigoranthus(BoatEntityRigoranthus.BoatModel model) {
//        super(new Item.Properties().stacksTo(1).tab(RigoranthusItemGroup.RIGORANTHUS_EMORTIS_GROUP));
//        this.model = model;
//        DispenserBlock.registerBehavior(this, new DispenserBoatBehavior(model));
//    }
//
//    @Override
...
//                BoatEntityRigoranthus boat = new BoatEntityRigoranthus(world, result.getLocation().x, result.getLocation().y, result.getLocation().z).withModel(this.model);
