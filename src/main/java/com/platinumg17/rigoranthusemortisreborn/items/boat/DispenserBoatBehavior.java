...
//
//public class DispenserBoatBehavior extends DefaultDispenseItemBehavior {
//    private final DefaultDispenseItemBehavior defaultDispenseItemBehavior = new DefaultDispenseItemBehavior();
//    private final BoatEntityRigoranthus.BoatModel model;
//
//    public DispenserBoatBehavior(BoatEntityRigoranthus.BoatModel model) {
//        this.model = model;
//    }
//
//    @Override
...
//            d3 = 0d;
//        }
//        BoatEntityRigoranthus boat = new BoatEntityRigoranthus(world, d0, d1 + d3, d2).withModel(this.model);
