        ...
        if(attacker instanceof PlayerEntity) {
            if(!((PlayerEntity) attacker).isCreative()) {
                ...
                if(!attacker.level.isClientSide) {
                    ...
                    stack.shrink(1);
                    ITextComponent message = new TranslationTextComponent("While handling the tooth, you feel a sharp sting and drop it.");
        ...
        if(entityLiving instanceof PlayerEntity) {
            if(!((PlayerEntity) entityLiving).isCreative()) {
                ...
                if(!entityLiving.level.isClientSide) {
                    ...
                    stack.shrink(1);
                    ITextComponent message = new TranslationTextComponent("While handling the tooth, you accidentally cut yourself and drop it.");
