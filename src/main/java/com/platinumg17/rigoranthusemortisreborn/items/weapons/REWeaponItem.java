...
public class REWeaponItem extends TieredItem {
    ...
    @Deprecated
    public REWeaponItem(IItemTier tier, int attackDamage, float attackSpeed, float efficiency, @Nullable REToolTypes toolType, Properties properties) {
    ...
    @Override public UseAction getUseAnimation(ItemStack stack) {return useAction;}
