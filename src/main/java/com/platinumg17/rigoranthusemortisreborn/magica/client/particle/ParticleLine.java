...
public class ParticleLine extends SpriteTexturedParticle {
    ...
    @Override public boolean isAlive() {return this.age < lifetime;}
    @Override public IParticleRenderType getRenderType() {return RenderTypes.EMBER_RENDER;}
    @Override public int getLightColor(float pTicks){
        return 255;
    }
}