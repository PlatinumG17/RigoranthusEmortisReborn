...
public class FixedGeoBlockItemRenderer<T extends AnimBlockItem & IAnimatable> extends GeoItemRenderer<AnimBlockItem> {
    ...
    public void render(AnimBlockItem animatable, MatrixStack stack, IRenderTypeBuffer bufferIn, int packedLightIn, ItemStack itemStack, ItemCameraTransforms.TransformType transformType) {
