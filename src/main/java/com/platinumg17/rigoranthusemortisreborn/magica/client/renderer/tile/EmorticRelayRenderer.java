...
public class EmorticRelayRenderer extends GeoBlockRenderer<EmorticRelayTile> {
    ...
    public EmorticRelayRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn, new EmorticRelayModel());
    }

    @Override
    public RenderType getRenderType(EmorticRelayTile animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
