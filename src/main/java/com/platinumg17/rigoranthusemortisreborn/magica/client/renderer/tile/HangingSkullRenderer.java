...
public class HangingSkullRenderer extends GeoBlockRenderer<HangingSkullTile> {
    ...
    public HangingSkullRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn, new HangingSkullModel());
    }

    @Override
    public RenderType getRenderType(HangingSkullTile animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
