...
public class IchorCrystallizerModel extends AnimatedGeoModel<IchorCrystallizerTile> {
    @Override
    public ResourceLocation getModelLocation(IchorCrystallizerTile crystallizerTile) {
        return new ResourceLocation(EmortisConstants.MOD_ID, "geo/ichor_crystallizer.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(IchorCrystallizerTile crystallizerTile) {
        return new ResourceLocation(EmortisConstants.MOD_ID, "textures/blocks/ichor_crystallizer.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(IchorCrystallizerTile crystallizerTile) {
