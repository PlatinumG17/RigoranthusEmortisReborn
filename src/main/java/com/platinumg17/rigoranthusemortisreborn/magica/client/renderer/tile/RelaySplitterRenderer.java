...
public class RelaySplitterRenderer extends GeoBlockRenderer<RelaySplitterTile> {
    ...
    @Override
    public RenderType getRenderType(RelaySplitterTile animatable, float partialTicks, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
