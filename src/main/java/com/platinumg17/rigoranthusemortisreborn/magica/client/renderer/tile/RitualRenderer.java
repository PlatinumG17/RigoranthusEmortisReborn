...
public class RitualRenderer extends TileEntityRenderer<RitualTile> {
    ...
    public void renderFloatingItem(RitualTile tileEntityIn, ItemEntity entityItem, double x, double y, double z, MatrixStack stack, IRenderTypeBuffer iRenderTypeBuffer){
        stack.pushPose();
    ...
    @Override
    public void render(RitualTile tileEntityIn, float v, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, int i1) {
