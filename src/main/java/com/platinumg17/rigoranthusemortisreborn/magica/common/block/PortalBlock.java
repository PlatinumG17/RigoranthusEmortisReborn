...
import com.platinumg17.rigoranthusemortisreborn.magica.common.datagen.Recipes;
...
public class PortalBlock extends ModBlock{
    protected static final VoxelShape SHAPE = box(0.0D, 0.0D, 0.0D, 14.0D, 12.0D, 14.0D);
