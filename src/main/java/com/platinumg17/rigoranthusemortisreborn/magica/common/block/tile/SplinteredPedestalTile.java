...
public class SplinteredPedestalTile extends AnimatedTile implements IInventory {
    private final LazyOptional<IItemHandler> itemHandler = LazyOptional.of(() -> new InvWrapper(this));
    public float frames;
    public ItemEntity entity;
    public ItemStack stack;

    public SplinteredPedestalTile() {
        super(BlockRegistry.SPLINTERED_PEDESTAL_TILE);
    }
