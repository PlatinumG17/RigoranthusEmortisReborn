...
import com.platinumg17.rigoranthusemortisreborn.api.apimagic.piratesbooty.LootTables;
...
public class DungeonLootGenerator extends GlobalLootModifierProvider {
    ...
    public static final DeferredRegister<GlobalLootModifierSerializer<?>> GLM = DeferredRegister.create(ForgeRegistries.LOOT_MODIFIER_SERIALIZERS, EmortisConstants.MOD_ID);
