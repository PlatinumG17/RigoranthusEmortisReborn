...
//        } // TODO recent removal
    ...
    @Override public void baseTick() {super.baseTick();}
    ...
    protected void onHit(RayTraceResult result) {
        if(!level.isClientSide &&  result != null && result.getType() == RayTraceResult.Type.ENTITY) {
            ...
            if(this.spellResolver != null) {
                ...
                Networking.sendToNearby(level, new BlockPos(result.getLocation()), new PacketREEffect(PacketREEffect.EffectType.BURST,
...
//            }
            ...
            Networking.sendToNearby(level, ((BlockRayTraceResult) result).getBlockPos(), new PacketREEffect(PacketREEffect.EffectType.BURST,
