...
public class FamiliarCadaver extends FamiliarEntity {
    ...
    public FamiliarCadaver(EntityType<? extends CreatureEntity> ent, World world) {
        super(ent, world);
    }
    ...
    public void tick() {
        ...
        if(!level.isClientSide && level.getGameTime() % 60 == 0 && getOwner() != null){
            getOwner().addEffect(new EffectInstance(Effects.JUMP, 600, 1, false, false, true));
        }
    }
...
//    public FamiliarCadaver(EntityType<? extends SunderedCadaverEntity> p_i50190_1_, World p_i50190_2_) {
//        super(ModEntities.FAMILIAR_CADAVER, p_i50190_2_);
//    }
//
//    public FamiliarCadaver(World p_i50190_2_, LivingEntity owner) {
...
//        GroundPathNavigator pathNav = new GroundPathNavigator(this, worldIn);
...
//                        this.yRot = -((float) MathHelper.atan2(vec3d1.x, vec3d1.z)) * (180F / (float)Math.PI);
