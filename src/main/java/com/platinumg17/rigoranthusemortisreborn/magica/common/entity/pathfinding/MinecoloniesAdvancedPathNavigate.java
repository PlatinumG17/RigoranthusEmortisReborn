...
import com.platinumg17.rigoranthusemortisreborn.magica.common.entity.pathfinding.pathjobs.PathJobMoveToLocation;
import com.platinumg17.rigoranthusemortisreborn.magica.common.entity.pathfinding.pathjobs.PathJobMoveToPathable;
...
public class MinecoloniesAdvancedPathNavigate extends AbstractAdvancedPathNavigate
{
     ...
     */
    public MinecoloniesAdvancedPathNavigate(final MobEntity entity, final World world)
    {
        super(entity, world);
        ...
        stuckHandler = PathingStuckHandler.createStuckHandler().withTakeDamageOnStuck(0.0F).withTeleportSteps(6).withTeleportOnFullStuck();
    }
            ...
            final double speedFactor)
    {
        ...
        {
            RigoranthusEmortisReborn.LOGGER.error("Tried to set a bad speed:" + speedFactor + " for entity:" + ourEntity, new Exception());
            return null;
        }
