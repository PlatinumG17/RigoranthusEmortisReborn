...
import static com.platinumg17.rigoranthusemortisreborn.magica.common.entity.pathfinding.PathingConstants.debugNodeMonitor;
...
public final class Pathfinding
{
    ...
    public static class MinecoloniesThreadFactory implements ThreadFactory
    {
        ...
        {
            final Thread thread = new Thread(runnable, "Rigoranthus [minecolonies] Pathfinding Worker #" + (id++));
            thread.setDaemon(true);

            thread.setUncaughtExceptionHandler((thread1, throwable) -> RigoranthusEmortisReborn.LOGGER.error("Rigoranthus [minecolonies] Pathfinding Thread errored! ", throwable));
            return thread;
        }
    }
    ...
    public static void debugDraw(final double frame, final MatrixStack matrixStack)
    {
        ...
        {
            RigoranthusEmortisReborn.LOGGER.catching(exc);
        }
