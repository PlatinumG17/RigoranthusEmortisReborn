...
import com.platinumg17.rigoranthusemortisreborn.magica.common.entity.pathfinding.*;
...
import static com.platinumg17.rigoranthusemortisreborn.magica.common.entity.pathfinding.PathingConstants.*;
...
public abstract class AbstractPathJob implements Callable<Path> {
    ...
    public final Path call() {
        try {
            ...
            RigoranthusEmortisReborn.LOGGER.warn("Pathfinding Exception", e);
        }
