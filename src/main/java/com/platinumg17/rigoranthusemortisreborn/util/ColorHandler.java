...
public class ColorHandler {
    ...
    public static ITextComponent getName(int index) {
        ...
        return new TranslationTextComponent("rigoranthusemortisreborn.color." + colors.get(index).getRight());
    }
...
//    public static int getColorForPlayer(ServerPlayerEntity player) {return getColorForPlayer(IdentifierHandler.encode(player), player.level);}
//    public static int getColorForPlayer(PlayerIdentifier identifier, World world) {return PlayerSavedData.getData(identifier, world).getColor();}
}
