...
// * https://github.com/TheCyberBrick/Spiders-2.0/blob/1.16.3/src/main/java/tcb/spiderstpo/common/goal/BetterLeapAtTargetGoal.java*/
...
//
//        this.leaper.setJumpDirection(jumpVector);
//
