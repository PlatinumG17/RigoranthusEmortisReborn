...
//            maxUpStep = MathHelper.floor(Math.max(1.0F, this.mob.maxUpStep));
//        }
//
//        double height = currentPoint.y - getFloorLevel(this.level, new BlockPos(currentPoint.x, currentPoint.y, currentPoint.z));
//
//        DirectionalPathPoint[] pathsPZ = this.getSafePoints(currentPoint.x, currentPoint.y, currentPoint.z + 1, maxUpStep, height, PZ, this.checkObstructions);
//        DirectionalPathPoint[] pathsNX = this.getSafePoints(currentPoint.x - 1, currentPoint.y, currentPoint.z, maxUpStep, height, NX, this.checkObstructions);
//        DirectionalPathPoint[] pathsPX = this.getSafePoints(currentPoint.x + 1, currentPoint.y, currentPoint.z, maxUpStep, height, PX, this.checkObstructions);
//        DirectionalPathPoint[] pathsNZ = this.getSafePoints(currentPoint.x, currentPoint.y, currentPoint.z - 1, maxUpStep, height, NZ, this.checkObstructions);
//
...
//            pathsNY = this.getSafePoints(currentPoint.x, currentPoint.y - 1, currentPoint.z, maxUpStep, height, NY, this.checkObstructions);
//
...
//            pathsPY = this.getSafePoints(currentPoint.x, currentPoint.y + 1, currentPoint.z, maxUpStep, height, PY, this.checkObstructions);
//
...
//            DirectionalPathPoint[] pathsNXNZ = this.getSafePoints(currentPoint.x - this.entityWidth, currentPoint.y, currentPoint.z - 1, maxUpStep, height, NXNZ, this.checkObstructions);
//
...
//                pathsNXNZ = this.getSafePoints(currentPoint.x - 1, currentPoint.y, currentPoint.z - this.entityDepth, maxUpStep, height, NXNZ, this.checkObstructions);
//
//                for(int k = 0; k < pathsNXNZ.length; k++) {
//                    if(this.isSuitablePoint(pathsNX, currentPoint.x - 1, currentPoint.y, currentPoint.z, pathsNZ, currentPoint.x, currentPoint.y, currentPoint.z - 1, pathsNXNZ[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                        pathOptions[openedNodeCount++] = pathsNXNZ[k];
...
//            DirectionalPathPoint[] pathsPXNZ = this.getSafePoints(currentPoint.x + 1, currentPoint.y, currentPoint.z - 1, maxUpStep, height, PXNZ, this.checkObstructions);
//
...
//            DirectionalPathPoint[] pathsNXPZ = this.getSafePoints(currentPoint.x - 1, currentPoint.y, currentPoint.z + 1, maxUpStep, height, NXPZ, this.checkObstructions);
//
...
//            DirectionalPathPoint[] pathsPXPZ = this.getSafePoints(currentPoint.x + this.entityWidth, currentPoint.y, currentPoint.z + 1, maxUpStep, height, PXPZ, this.checkObstructions);
//
//            boolean foundDiagonal = false;
//
...
//
//            if(!foundDiagonal && (this.entityWidth != 1 || this.entityDepth != 1)) {
//                pathsPXPZ = this.getSafePoints(currentPoint.x + 1, currentPoint.y, currentPoint.z + this.entityDepth, maxUpStep, height, PXPZ, this.checkObstructions);
//
//                for(int k = 0; k < pathsPXPZ.length; k++) {
//                    if(this.isSuitablePoint(pathsPX, currentPoint.x + 1, currentPoint.y, currentPoint.z, pathsPZ, currentPoint.x, currentPoint.y, currentPoint.z + 1, pathsPXPZ[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                        pathOptions[openedNodeCount++] = pathsPXPZ[k];
...
//                DirectionalPathPoint[] pathsNYNX = this.getSafePoints(currentPoint.x - this.entityWidth, currentPoint.y - 1, currentPoint.z, maxUpStep, height, NXNY, this.checkObstructions);
//
//                boolean foundDiagonal = false;
//
...
//                    pathsNYNX = this.getSafePoints(currentPoint.x - 1, currentPoint.y - this.entityHeight, currentPoint.z, maxUpStep, height, NXNY, this.checkObstructions);
//
//                    for(int k = 0; k < pathsNYNX.length; k++) {
//                        if(this.isSuitablePoint(pathsNY, currentPoint.x, currentPoint.y - 1, currentPoint.z, pathsNX, currentPoint.x - 1, currentPoint.y, currentPoint.z, pathsNYNX[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                            pathOptions[openedNodeCount++] = pathsNYNX[k];
...
//                DirectionalPathPoint[] pathsNYPX = this.getSafePoints(currentPoint.x + 1, currentPoint.y - 1, currentPoint.z, maxUpStep, height, PXNY, this.checkObstructions);
//
...
//                DirectionalPathPoint[] pathsNYNZ = this.getSafePoints(currentPoint.x, currentPoint.y - this.entityHeight, currentPoint.z - 1, maxUpStep, height, NYNZ, this.checkObstructions);
//
//                boolean foundDiagonal = false;
//
...
//                    pathsNYNZ = this.getSafePoints(currentPoint.x, currentPoint.y - 1, currentPoint.z - this.entityDepth, maxUpStep, height, NYNZ, this.checkObstructions);
//
//                    for(int k = 0; k < pathsNYNZ.length; k++) {
//                        if(this.isSuitablePoint(pathsNY, currentPoint.x, currentPoint.y - 1, currentPoint.z, pathsNZ, currentPoint.x, currentPoint.y, currentPoint.z - 1, pathsNYNZ[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                            pathOptions[openedNodeCount++] = pathsNYNZ[k];
...
//                DirectionalPathPoint[] pathsNYPZ = this.getSafePoints(currentPoint.x, currentPoint.y - 1, currentPoint.z + 1, maxUpStep, height, NYPZ, this.checkObstructions);
//
...
//                DirectionalPathPoint[] pathsPYNX = this.getSafePoints(currentPoint.x - 1, currentPoint.y + 1, currentPoint.z, maxUpStep, height, NXPY, this.checkObstructions);
//
...
//                DirectionalPathPoint[] pathsPYPX = this.getSafePoints(currentPoint.x + this.entityWidth, currentPoint.y + 1, currentPoint.z, maxUpStep, height, PXPY, this.checkObstructions);
//
//                boolean foundDiagonal = false;
//
...
//
//                if(!foundDiagonal && (this.entityWidth != 1 || this.entityHeight != 1)) {
//                    pathsPYPX = this.getSafePoints(currentPoint.x + 1, currentPoint.y + this.entityHeight, currentPoint.z, maxUpStep, height, PXPY, this.checkObstructions);
//
//                    for(int k = 0; k < pathsPYPX.length; k++) {
//                        if(this.isSuitablePoint(pathsPY, currentPoint.x, currentPoint.y + 1, currentPoint.z, pathsPX, currentPoint.x + 1, currentPoint.y, currentPoint.z, pathsPYPX[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                            pathOptions[openedNodeCount++] = pathsPYPX[k];
...
//                DirectionalPathPoint[] pathsPYNZ = this.getSafePoints(currentPoint.x, currentPoint.y + 1, currentPoint.z - 1, maxUpStep, height, PYNZ, this.checkObstructions);
//
...
//                DirectionalPathPoint[] pathsPYPZ = this.getSafePoints(currentPoint.x, currentPoint.y + this.entityHeight, currentPoint.z + 1, maxUpStep, height, PYPZ, this.checkObstructions);
//
//                boolean foundDiagonal = false;
//
...
//
//                if(!foundDiagonal && (this.entityHeight != 1 || this.entityDepth != 1)) {
//                    pathsPYPZ = this.getSafePoints(currentPoint.x, currentPoint.y + 1, currentPoint.z + this.entityDepth, maxUpStep, height, PYPZ, this.checkObstructions);
//
//                    for(int k = 0; k < pathsPYPZ.length; k++) {
//                        if(this.isSuitablePoint(pathsPY, currentPoint.x, currentPoint.y + 1, currentPoint.z, pathsPZ, currentPoint.x, currentPoint.y, currentPoint.z + 1, pathsPYPZ[k], currentPoint, this.checkObstructions, fitsThroughPoles, is3DPathing)) {
//                            pathOptions[openedNodeCount++] = pathsPYPZ[k];
...
//
//    @Nullable
//    private DirectionalPathPoint[] getSafePoints(int x, int y, int z, int maxUpStep, double height, Vector3i direction, boolean allowBlocked) {
...
//            PathNodeType nodeType = unpackNodeType(packed);
//
//            float malus = this.advancedPathFindingEntity.getPathingMalus(this.level, this.mob, nodeType, pos, direction, dir -> unpackDirection(dir, initialPacked)); //Replaces EntityLiving#getPathfindingMalus
//
...
//                return result;
//            } else {
//                if (directPathPoint == null && maxUpStep > 0 && nodeType != PathNodeType.FENCE && nodeType != PathNodeType.UNPASSABLE_RAIL && nodeType != PathNodeType.TRAPDOOR && direction.getY() == 0 && Math.abs(direction.getX()) + Math.abs(direction.getY()) + Math.abs(direction.getZ()) == 1) {
//                    DirectionalPathPoint[] pointsAbove = this.getSafePoints(x, y + 1, z, maxUpStep - 1, height, direction, false);
...
//            return getBlockPathTypeRaw(blockaccessIn, pos);
//        });
//    }
//
