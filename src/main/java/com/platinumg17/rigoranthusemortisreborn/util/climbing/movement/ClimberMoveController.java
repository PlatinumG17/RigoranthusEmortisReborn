...
//
//            if(processor != null && processor.getBlockPathType(this.mob.level, MathHelper.floor(this.mob.getPosX() + x), MathHelper.floor(this.mob.getPosY() + this.mob.getHeight() * 0.5f + y), MathHelper.floor(this.mob.getPosZ() + z)) != PathNodeType.WALKABLE) {
//                return false;
//            }
//        }
//
