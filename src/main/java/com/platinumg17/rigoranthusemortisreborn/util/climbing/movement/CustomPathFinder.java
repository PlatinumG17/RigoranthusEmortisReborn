...
//            }).min(Comparator.comparingInt(Path::getpathLength));
//        } else {
...
//            }).min(Comparator.comparingDouble(Path::func_224769_l /*TODO Replace calculation with cost heuristic*/).thenComparingInt(Path::getpathLength));
//        }
//
