package com.platinumg17.rigoranthusemortisreborn.util.paintings;
...
public abstract class HangingArtEntity<T extends HangingArtEntity.IArt> extends HangingEntity implements IEntityAdditionalSpawnData {
    public T art;
    public HangingArtEntity(EntityType<? extends HangingArtEntity<T>> type, World worldIn) {super(type, worldIn);}
    ...
    public void readAdditionalSaveData(CompoundNBT compound) {
        ...
        if(this.art == null) {
            ...
            REDebug.warnf("Could not load art %s for type %s, resorting to the default type.", s, this.getType().getDescriptionId());
        }
    ...
    @Override
    public int getWidth() {return art == null ? 1 : art.getSizeX();}

    @Override public int getHeight() {return art == null ? 1 : art.getSizeY();}
