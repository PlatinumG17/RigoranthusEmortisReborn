...
public class RenderWallArt<T extends HangingArtEntity<?>> extends EntityRenderer<T> {
    private final ResourceLocation ART_TEXTURE;

    public RenderWallArt(EntityRendererManager renderManagerIn, ResourceLocation artPath) {
    ...
    @Override
    public ResourceLocation getTextureLocation(HangingArtEntity entity) {return ART_TEXTURE;}
