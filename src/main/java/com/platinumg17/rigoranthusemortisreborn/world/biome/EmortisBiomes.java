...
private static Biome makeVerdurousWoodlandsBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
    ...
    MobSpawnInfo.Builder mobSpawnInfo = new MobSpawnInfo.Builder().setPlayerCanSpawn();
        ...
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.JESSIC.chance(Config.jessicSpawnWeight.get()));
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.LOOMING_JESSIC.chance(Config.loomingJessicSpawnWeight.get()));
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.MEGA_JESSIC.chance(Config.megaJessicSpawnWeight.get()));
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.AZULOREAL.chance(Config.azulorealSpawnWeight.get()));
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.LOOMING_AZULOREAL.chance(Config.loomingAzulorealSpawnWeight.get()));
        builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, RigoranthusConfiguredFeatures.MEGA_AZULOREAL.chance(Config.megaAzulorealSpawnWeight.get()));
