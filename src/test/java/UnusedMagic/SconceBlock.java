...
//import com.platinumg17.rigoranthusemortisreborn.magica.common.block.tile.SconceTile;
...
//            Maps.newEnumMap(ImmutableMap.of(Direction.NORTH, box(5D, 3.0D, 11.0D, 11D, 13.0D, 16.0D),
//                    Direction.SOUTH, box(5.0, 3.0D, 0.0D, 11D, 13.0D, 5.0D),
//                    Direction.WEST, box(11.0D, 3.0D, 5.5D, 16.0D, 13.0D, 10.5D), Direction.EAST, box(0.0D, 3.0D, 5.5D, 5.0D, 13.0D, 10.5D)));
...
//        } else {
//            // The player tried to place on the floor or ceiling. No Model for these.
