...
//
//public class DataCheckerPacket implements IPlayerToBothPacket {
...
//    }
//
//    public static DataCheckerPacket data(int index, CompoundNBT nbtData) {return new DataCheckerPacket(index, nbtData);}
//
//    @Override
...
//            try {nbt = CompressedStreamTools.readCompressed(new ByteArrayInputStream(bytes));}
//            catch(IOException e) {e.printStackTrace();}
//        }
...
//    }
//    @Override public void execute(ServerPlayerEntity player) {DataCheckerManager.onDataRequest(player, packetIndex);}
//}