package WeirdFailedProjects.netnotwork.arguments;
...
import com.platinumg17.rigoranthusemortisreborn.core.init.aspects.EnumAspect;
import com.platinumg17.rigoranthusemortisreborn.core.init.aspects.EnumClass;
...
public class TitleArgument implements ArgumentType<Title> {
    private static final List<String> EXAMPLES = Arrays.asList("heir light", "void", "doom");
