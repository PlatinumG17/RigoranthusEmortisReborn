...
//    private static final String DATA_NAME = EmortisConstants.MOD_ID+"_player_data";
//
...
//    }
//
//    public static PlayerData getData(ServerPlayerEntity player) {return get(player.server).getData(IdentifierHandler.encode(player));}
//
//    public static PlayerData getData(PlayerIdentifier player, World world) {return get(world).getData(player);}
//
//    public static PlayerData getData(PlayerIdentifier player, MinecraftServer server) {return get(server).getData(player);}
//
