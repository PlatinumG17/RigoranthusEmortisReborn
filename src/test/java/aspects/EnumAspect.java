...
public enum EnumAspect {
     ...
     */
    public static int getIntFromAspect(EnumAspect e) {return e.ordinal();}
    ...
    public String getTranslationKey() {return "title.aspect." + this.toString();}
    public static Set<EnumAspect> valuesSet() {return EnumSet.allOf(EnumAspect.class);}
}
//TODO This could potentially be changed to a registry. However note difficulties with the title land aspect registry