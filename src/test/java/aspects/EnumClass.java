...
/**
 * This class represents the 14 title-classes that exists
...
public enum EnumClass {
    ...
    EnumClass(boolean usedInGeneration) {this.usedInGeneration = usedInGeneration;}
     ...
     */
    public static int getIntFromClass(EnumClass e) {return e.ordinal();}
     ...
     */
    public ITextComponent asTextComponent() {return new TranslationTextComponent(getTranslationKey());}
    public String getTranslationKey() {return "title.class." + this.toString();}
    public boolean isUsedInGeneration() {return usedInGeneration;}
    public static Stream<EnumClass> valuesStream() {return Stream.of(values()).filter(EnumClass::isUsedInGeneration);}
}